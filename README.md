...
- 翻訳について
    ...
    - 英語圏の某氏のご協力により、一部のバージョンの英語対応版を作成して頂きました。
      開発版ベースの別バージョンとなりますので、ダウンロードページからご入手ください。
...
- 同梱modについて
  ...
  - 変更 - ビタミンによる能力アップ
    - 各種ビタミンの過剰摂取によるささやかな能力値アップと、最大段階のビタミン欠乏症にささやかな能力値ペナルティを追加します。
  - 追加 - Hentai Mod Reloaded
	- サキュバスなどのモンスターを初めとしたHENTAI的な要素を追加します。詳しくはmodファイル内のドキュメントを見てください。
  - Basic特殊淫魔セリフ
    - Hentai Modに登場する特殊能力を持った上位の淫魔たちに、友好状態を想定した各種待機セリフを追加します。
...
## 主な共同開発者について
  ...
  - lispcoc < https://github.com/lispcoc > (主にHentaiの移植)
  - Ezsk < https://github.com/Ezsk > (各種不具合修正)
  - m_kw (Hentai用タイルのご提供)
  - T5idr3 (エンチャントのコンテンツ作成)
  - まだ温かい (各種不具合修正)
  - Nonesuch (英語バージョン作成)
...
このヴァリアントには以上の開発者・協力者によってつくられました。みなさまのご協力に大変感謝します。
